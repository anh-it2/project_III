 ...
 * than this app, so the httpOnly cookie is never sent on the cross-site socket
 * handshake. This route is same-origin, so the cookie IS readable here; we
 * relay only the token value to the client.
 *
